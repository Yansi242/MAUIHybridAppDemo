...
@dso_cache = dso_local local_unnamed_addr global [696 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 18892142, ; hash 0x120456e, from name: MauiBlazorHybridApp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 743576836, ; hash 0x2c521504, from name: aot-MauiBlazorHybridApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiBlazorHybridApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 103
	...
	%struct.DSOCacheEntry {
		i64 987960067, ; hash 0x3ae31303, from name: MauiBlazorHybridApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiBlazorHybridApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 149
	...
	%struct.DSOCacheEntry {
		i64 1597763380, ; hash 0x5f3bef34, from name: libaot-MauiBlazorHybridApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiBlazorHybridApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 252
	%struct.DSOCacheEntry {
		i64 1612479186, ; hash 0x601c7ad2, from name: libaot-MauiBlazorHybridApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiBlazorHybridApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 253
	...
	%struct.DSOCacheEntry {
		i64 3589744834, ; hash 0xd5f728c2, from name: aot-MauiBlazorHybridApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiBlazorHybridApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 592
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [146 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
